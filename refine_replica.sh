...
#SBATCH --job-name=lotus2_replica_refiner
...
#SBATCH --output=lotus2_replica_refiner_%j.log
#SBATCH --error=lotus2_replica_refiner_%j.err
...
OUTPUT_DIR=outputs/refiner_replica_disp

echo ">>> Start Lotus-2 Replica depth refiner finetuning"
echo ">>> Python: ${PYTHON}"
...
${PYTHON} finetuning.py \
    ...
    --replica_scale=0.5 \
    --crop_mode=original \
    --depth_normalization=trunc_disparity \
